...
#define CYBLE_RGB_LED_SERVICE_HANDLE   (0x000Eu) /* Handle of RGB LED service */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x000Fu) /* Handle of RGB LED Control characteristic declaration */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x0010u) /* Handle of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
